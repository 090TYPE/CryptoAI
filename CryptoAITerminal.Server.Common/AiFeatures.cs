...
public static class AiFeatures
{
    ...
    [
        ...
        new("token_security",      "Проверка безопасности токена",                1200),
        new("statarb_pair",        "Поиск пар для статарбитража",                  800),
        new("execution_schedule",  "График исполнения заявки",                     900),
        new("dynamic_tpsl",        "Динамические тейк-профит и стоп-лосс",         800),
        new("signal",              "Торговый сигнал",                              800),
        new("news_digest",         "Сводка новостей",                              800),
        new("alert_spec",          "Разбор условия алерта",                        800),
    ];

...
public class PnlDashboardViewModel : ReactiveObject
{
    ...
    public string TotalPnlBrush    => _totalPnlUsd >= 0 ? SemanticColor.Keys.Positive : SemanticColor.Keys.Negative;
...
public sealed class PeriodRowViewModel
{
    ...
    public string PnlBrush => _row.PnlUsd >= 0 ? SemanticColor.Keys.Positive : SemanticColor.Keys.Negative;
...
public sealed class TradeRowViewModel
{
    ...
    public string PnlBrush    => _t.PnlUsd >= 0 ? SemanticColor.Keys.Positive : SemanticColor.Keys.Negative;
